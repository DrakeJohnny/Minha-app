                ...
                <table class="table table-bordered dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center pr-4"><?php echo ($forma->forma_pagamento_ativa == 1 ? '<span class="badge badge-success btn-sm">Sim</span>' : '<span class="badge badge-danger btn-sm">Não</span>') ?></td>
                      <td class="text-right">
