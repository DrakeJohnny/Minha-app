  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page"><?php echo $titulo; ?></li>
      ...
      <div class="col-md-2 mb-3">
           ...
           <input type="text" class="form-control form-control-user" name="produto_codigo" placeholder="Código interno do produto" value="<?php echo $produto->produto_codigo; ?> "readonly="">
      </div> 
