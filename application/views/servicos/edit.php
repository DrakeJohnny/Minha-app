    ...
    <?php echo form_error('servico_preco', '<small class="form-text text-danger">','</small>'); ?>
      ...
      <div class="form-group row mb-3">
          ...
          <div class="col-md-12">
           ...
           <textarea class="form-control form-control-user" rows="5" name="servico_descricao" style="min-height: 100px!important"><?php echo $servico->servico_descricao; ?></textarea>
