...
class Produtos extends CI_Controller{
    ...
    public function edit($produto_id = NULL) {
        ...
        if(!$produto_id || !$this->core_model->get_by_id('produtos', array('produto_id' => $produto_id))){
            ...
            $this->form_validation->set_rules('produto_obs', 'Observações do produto', 'trim|max_length[200]');
    ...
    public function check_produto_preco_venda($produto_preco_venda) {
        ...
        if($produto_preco_custo > $produto_preco_venda){
            $this->form_validation->set_message('check_produto_preco_venda', 'Preço de venda deve ser igual ou maior do que o preço de custo');
            return FALSE;
        }else{
            return TRUE;
        }
