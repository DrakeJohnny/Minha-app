...
class Clientes extends CI_Controller{
    ...
    public function add(){
        ...
        $this->form_validation->set_rules('cliente_nome', '', 'trim|required|min_length[4]|max_length[45]');
            ...
            if($cliente_tipo == 1){
                ...
                $this->form_validation->set_rules('cliente_cnpj', '', 'trim|required|exact_length[18]|is_unique[clientes.cliente_cp_cnpj]|callback_valida_cnpj');
            }
    ...
    public function check_celular($cliente_celular){
        ...
        if($this->core_model->get_by_id('clientes', array('cliente_celular' => $cliente_celular, 'cliente_id !=' => $cliente_id))){
            ...
            $this->form_validation->set_message('check_celular', 'Este celular já existe');
            return FALSE;
